     ...
     return (
        <div className="container pt-40">
          <div className="space-y-4 w-fit mx-auto text-center">
            ...
            Our menu offers a delightful variety of dishes made with fresh ingredients and bold flavors. From tasty appetizers to hearty entrees and sweet desserts, there’s something for everyone to enjoy!
